...
// Configure Jura as a geometric sans-serif fallback for Phenomena
const jura = Jura({
  variable: '--font-jura',
  subsets: ['latin'],
  display: 'swap',
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} ${jura.variable} light`}>
      <body className="min-h-screen flex flex-col bg-bg-primary text-text-primary">
        ...
        <div aria-hidden="true" className="fixed inset-0 overflow-hidden pointer-events-none z-0">
          <div className="absolute -top-40 -left-40 w-175 h-175 rounded-full bg-[radial-gradient(circle,rgba(160,67,10,0.10)_0%,transparent_70%)] animate-drift" />
          ...
          <div className="absolute -bottom-40 left-1/3 w-150 h-150 rounded-full bg-[radial-gradient(circle,rgba(160,67,10,0.06)_0%,transparent_70%)] animate-drift" />
        </div>
        <AuthProvider>
          <Header />
